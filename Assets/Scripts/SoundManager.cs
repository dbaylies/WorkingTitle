...
public class SoundManager : Singleton<SoundManager>
{
    ...
    private float DetermineFrequency()
    {
        ...
        // Obv clean up this code
        HandInstrumentRight.PadDirection direction = GameObject.Find("Controller (right)").GetComponent<HandInstrumentRight>().GetPadDirection();
        float right_height = GameObject.Find("Controller (right)").GetComponent<HandInstrumentRight>().GetHeight();
